...
하지만 운석이라기엔 무언가 떨어진것을 본적이 없다.
만약 이런게 하늘에서 보던 유성이라면 아마 제리는 다시는 유성이 예쁘다고 말하지 않을것이라고 생각했다.
제리는 혹시나 하는 마음에 잭부터 찾아보았다.
다행이도 잭은 옆에서 멍하니 서있었다.
이러한 생각이 모두 마치기도 전에 코가 매워지는 것을 제리는 느꼈다. 
